...
public class CNMaterialRules {
    ...
    public static final SurfaceRules.RuleSource LEAD_BLOCK = makeStateRule(CNBlocks.LEAD_BLOCK.get());
    ...
    public static SurfaceRules.RuleSource makeRules()
    {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.ifTrue(SurfaceRules.isBiome(CNBiome.IRRADIATED_BIOME), LEAD_BLOCK),
